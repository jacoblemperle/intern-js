import generateTwitterSocialActivity from '../generators/generateTwitterSocialActivity';

export default class TwitterConsumer {
    ...
    onMessage (message) {
        ...
        const socialActivity = generateTwitterSocialActivity(parsedMessage);
        if (socialActivity) {
